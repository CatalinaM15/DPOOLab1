...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais del atleta con el Nombre");
	...
	private void ejecutarConsultaNombreAtleta() {
		System.out.println("\n" + "Pais del atleta por Nombre" + "\n");

		String nombre = input("Por favor ingrese el nombre de un atleta");
		System.out.println("El atleta " + nombre + " es del Pais " + calculadora.PaisdeAtleta(nombre));
